      ...
      <DashboardLayout>
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-black dark:text-white">Service Records</h1>
              <p className="text-gray-600 dark:text-gray-400 mt-2">Manage car wash service appointments</p>
            </div>
              ...
              <DialogContent className="sm:max-w-[500px]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="recordNumber" className="text-sm text-gray-700 dark:text-gray-300">
                      Record Number
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="serviceDate" className="text-sm text-gray-700 dark:text-gray-300">
                      Service Date
                    </Label>
                    <Input
                      id="serviceDate"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="car" className="text-sm text-gray-700 dark:text-gray-300">
                      Select Car
                    </Label>
                    <Select
                      value={formData.car}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="package" className="text-sm text-gray-700 dark:text-gray-300">
                      Select Package
                    </Label>
                    <Select
            ...
            {services.length === 0 ? (
              <Card className="border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-black">
                <CardContent className="flex flex-col items-center justify-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-black dark:text-white mb-2">No service records</h3>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600 dark:text-gray-400">{service.recordNumber}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600 dark:text-gray-400">By {service.user.username}</span>
                        </div>
