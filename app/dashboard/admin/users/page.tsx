...
import { Users, Mail, Calendar, Shield, User, Eye } from "lucide-react"
          ...
          <LoadingOverlay loading={loading}>
            {users.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {users.map((userData) => (
                  <Card key={userData._id} className="border dark:border-neutral-800 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            src={
                              userData.profileImage
                                ? userData.profileImage.startsWith("http")
                                  ? userData.profileImage
                                  : `${process.env.NEXT_PUBLIC_API_URI}${userData.profileImage}`
                                : "/placeholder.svg"
                            }
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="pt-3 border-t">
                          <Link href={`/dashboard/admin/users/${userData._id}`}>
                            <Button
                              variant="outline"
                              size="sm"
